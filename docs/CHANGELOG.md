...
- ✨ feat：聊天窗支持拖拽缩放、本地持久化与清除聊天记录 `🧑‍💻 lixingwen`
...
- ✨ feat：支持 Zip 技能包和隔离脚本执行 `🧑‍💻 lixingwen`

## - 2026-08-03
- ✨ feat：新增后端日期文件日志 `🧑‍💻 lixingwen`
...
## - 2026-07-20
- ✨ feat：搭建后端基础设施并实现用户模块闭环 `🧑‍💻 lixingwen`
